...
- **Website:** [GrimmLab](https://bit.cs.tum.de/en/)
...
- **Website:** [Translational Microbiome Data Integration](https://www.mls.ls.tum.de/en/mdi/home/)
...
- **Website:** [Helmholtz Munich - Microbial Ecology](https://www.helmholtz-munich.de/comi)
...
- **Website:** [TUM Plant Breeding](https://www.pflanzenzuechtung.wzw.tum.de/)

#### **Plant Systems Biology**
- **Professor:** Claus Schwechheimer
- **Focus:** Plant hormone signaling, systems approaches in plant biology
- **Website:** [Plant Systems Biology](https://www.mls.ls.tum.de/en/plasysbio/home/)
...
- **Website:** [Computational Plant Biology](https://www.mls.ls.tum.de/cpb/startseite/)
...
- **Website:** [AI and Informatics in Medicine](https://kiinformatik.mri.tum.de/en)
...
- **Website:** [Institute of Molecular Oncology and Functional Genomics](https://imo.med.tum.de/en)
...
1. **Explore our resources** - Check out the [Data Types](/domain-knowledge/bioinformatics/bio-data-types) and [Use Cases](/domain-knowledge/bioinformatics/use-cases/reference-based-analysis)
3. **Access infrastructure** - Apply for computing resources at [LRZ](https://www.lrz.de/)
4. **Get support** - Contact [researchdata@tum.de](mailto:researchdata@tum.de) for data management guidance
