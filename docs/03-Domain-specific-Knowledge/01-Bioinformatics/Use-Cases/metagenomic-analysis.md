...
Metagenomic assembly is extremely resource-intensive. Use **LRZ AI Systems** or high-memory cluster nodes. See [Infrastructure Guide](/general-knowledge/infrastructure).
:::
